	...
	<div class="d-flex justify-content-between align-items-center">
		<div  class="d-flex align-items-center gap-2">
			<security:authorize access="isAuthenticated()">
				...
				<c:choose>
					<c:when test="${principal.account.posiId == '7'}">
					...
					<c:otherwise>
						...
						<button style="display: none;" type="button" class="btn btn-primary me-2" onclick="triggerFileInput()">
							<img src="data:image/png;base64,"/>
							파일 업로드
						</button>
						<button type="button" class="btn btn-primary me-2" id="downloadBtn">
							<img src="data:image/png;base64,"/>
							파일 다운로드</button>
						<button style="display: none;" type="button" class="btn btn-primary me-2" data-bs-toggle="modal" data-bs-target="#smallModal">
							<img src="data:image/png;base64,"/>
						</button>
						<button style="display: none;" type="button" class="btn btn-secondary me-2" id="deleteBtn">
							<img src="data:image/png;base64,"/>
						</button>
						<button style="display: none;" type="button" class="btn btn-primary" id="fileMoveBtn">
							파일 이동
						</button>
						<button style="display: none;" type="button" class="btn btn-warning" id="pasteBtn" style="display: none;">
							이동하기
						</button>
					</c:otherwise>
				</c:choose>
				...
				<td colspan="2" id="cloudView">
					...
					<table class="table" id="cloudStorage">
					    ...
					    <tbody>
							            ...
							            <tr>
							                ...
							                <td>
												...
												<c:if test="${fn:endsWith(file.name, '.jpg')}">
												    <img id="fileIcon" alt="fileImg" src="${pageContext.request.contextPath}/resources/images/icon/icon-jpg.png" />
												</c:if>
							...
							<c:otherwise>
								<tr>
									<td colspan="4">아직 파일이 추가되지 않았어요ㅠ</td>
								</tr>
							</c:otherwise>
						</c:choose>
					    </tbody>
...
<script>
	...
	const currentPath = "${cloud.pubCloudPath}"
...
<script src="${pageContext.request.contextPath}/resources/js/app/cloud/publicStorage.js"></script>