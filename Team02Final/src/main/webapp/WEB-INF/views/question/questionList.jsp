            ...
            <c:if test="${not empty QuestionList}">
                <c:forEach items="${QuestionList }" var="question">
                    <tr>
                        ...
                        <td>
                            <a href="javascript:void(0);" onclick="checkAccess('${question.quSecretyn}', '${question.quNo}', `${empId }`, '${question.questionId}')">${question.quTitle }</a>
		...
		<tr>
		    <td colspan="5">
		        <div class="pagination-bar">
		            ...
		            <!-- 문의 작성 버튼 -->
		            <button type="button" class="btn btn-primary" id="questionWrite" 
		                data-lc-add="${pageContext.request.contextPath}/${companyId}/question/new">
