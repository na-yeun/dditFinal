...
<%@ taglib uri="http://www.springframework.org/security/tags"
	prefix="security"%>
<script
	src="${pageContext.request.contextPath }/resources/js/app/message/sendMessageModalEvery.js"></script>
...
<!-- 쪽지 쓰기 Modal -->
<input type="hidden" id="sendMessgeHidden" data-url="${pageContext.request.contextPath}/${companyId}/message/send"/>
					...
					<div class="mb-3">
					    ...
					    <div class="d-flex align-items-center" style="gap: 5px;">
					        ...
					        <button type="button" id="addReceiverButton" class="btn btn-primary"
					            style="align-self: flex-start; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
...
<script>
const contextPathMessage = "${pageContext.request.contextPath}";
