...
public class PublicCloudStorageController {
	...
	public Map<String, Object> getPersonalCloudStorageJson(
	    ...
	    // 현재 경로(prefix) 설정
	    String prefix =cloud.getPubCloudPath()+path;
	...
	public ResponseEntity<String> moveObjects(
	    ...
	    copyObjects.copyObjects(s3, cloud.getContractBucket(), cloud.getPubCloudPath(), moveObjectDTO.getMoveSelected(), moveObjectDTO.getTargetPaths());
	...
	public Map<String, Object> searchObjects(
	    ...
	    AmazonS3 s3 = awsUser.getAWSUser(cloud.getProvAccesskey(), cloud.getProvSecretkey());
	    Map<String, Object> searchMap = searchObjects.searchObjects(s3, cloud.getContractBucket(), cloud.getPubCloudPath(), searchKeyWord);
	...
	public ResponseEntity<ThumbnailDTO> thumbnail(
		...
		try {
			String thumbnailPath = cloud.getPubCloudPath()+filePath;
	...
	public ResponseEntity<?> deleteObjects(
		...
		deleteObjects.DeleteObjects(s3, cloud.getContractBucket(), cloud.getPubCloudPath(), selectedObjects);
	...
	public ResponseEntity<?> makeDir(
		...
		insertFolder.createFolder(s3, cloud.getContractBucket(), cloud.getPubCloudPath(), dirName);
	...
	public ResponseEntity<?> uploadFiles(
		...
		uploadObject.insertPerCloudObject(s3, cloud.getContractBucket(), cloud.getPubCloudPath(), folderName, files);
